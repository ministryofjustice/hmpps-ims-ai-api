...
[![Ministry of Justice Repository Compliance Badge](https://github-community.service.justice.gov.uk/repository-standards/api/hmpps-ims-ai-api/badge?style=flat)](https://github-community.service.justice.gov.uk/repository-standards/hmpps-ims-ai-api)
[![Docker Repository on ghcr](https://img.shields.io/badge/ghcr.io-repository-2496ED.svg?logo=docker)](https://ghcr.io/ministryofjustice/hmpps-ims-ai-api)
[![API docs](https://img.shields.io/badge/API_docs_-view-85EA2D.svg?logo=swagger)](https://ims-ai-api-dev.hmpps.service.justice.gov.uk/swagger-ui/index.html)
...
Our security policy is located [here](https://github.com/ministryofjustice/hmpps-ims-ai-api/security/policy).
...
## Renaming from HMPPS Ims Ai Api - github Actions
...
```bash
docker compose pull && docker compose up --scale hmpps-ims-ai-api=0
```
